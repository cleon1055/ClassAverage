...
captre user input 5 times for their grades
each time we capture a users input, we append the number to the list
sort the list acending, the slice the items starting at index 2
